...
def haga():
    e1 = caj.get()
    if not e1:
        messagebox.showerror("Error", "Ingrese una valor")
    result = funci(e1)
    #resultados
    poblacion = result[2]
    #Leche de soya
    ext1 = tk.Label(ventana,text="" + str(poblacion[0]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext1.place(x=430, y=140)
    #galletas
    ext3 = tk.Label(ventana,text="" + str(poblacion[1]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext3.place(x=430, y=190)    
    #Agua
    ext5 = tk.Label(ventana,text="" + str(poblacion[2]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext5.place(x=430, y=240)
    #Pan
    ext7 = tk.Label(ventana,text="" + str(poblacion[3]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext7.place(x=420, y=290)
    #Huevo
    ext9 = tk.Label(ventana,text="" + str(poblacion[4]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext9.place(x=420, y=340)
    #nueces
    ext11 = tk.Label(ventana,text="" + str(poblacion[5]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext11.place(x=420, y=390)
    #Yogurt
    ext2 = tk.Label(ventana,text="" + str(poblacion[6]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext2.place(x=630, y=140)
    #Manzana
    ext4 = tk.Label(ventana,text="" + str(poblacion[7]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ...
    #RedBull
    ext10 = tk.Label(ventana,text="" + str(poblacion[10]), width="5", height="1", font=("Helvetica 14"), bg='white')
    ext10.place(x=620, y=340)
    #total peso
    ext12 = tk.Label(ventana,text="" + str(result[0]), width="5", height="1", font=("Helvetica 14"), bg='white')
